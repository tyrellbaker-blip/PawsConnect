...
def pet_photo_path(instance, filename):
    # Generates a dynamic path for pet photos.
    # This path uses the pet's actual slug (generated by AutoSlugField) and appends the original filename.
    return 'pet_photos/{0}/{1}'.format(instance.pet.slug, filename)
